        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt" v-if="courseInfo.price===0">
              <a href="#lh-menu" title="立即观看" class="comm-btn c-btn-3" >立即观看</a>
            </section>
            <section class="c-attr-mt" v-else-if="isBuy===true">
              <a href="#lh-menu" title="立即观看" class="comm-btn c-btn-3" >立即观看</a>
            </section>
...
<script>
  ...
  export default {
    ...
    methods: {
      getCourseInfo() {
        courseApi.getCourseInfo(this.$route.params.id).then(resp => {
      ...
      createOrder(){
        orderApi.createOrder(this.courseId).then(resp=>{
          this.$router.push("/order/"+resp.data.orderNo);
        })
      },
    }
  }
